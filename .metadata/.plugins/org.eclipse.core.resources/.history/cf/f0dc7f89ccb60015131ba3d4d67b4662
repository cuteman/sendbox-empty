    	...
    	<div class="col-md-4 col-md-offset-4">
    		<div class="panel panel-default">
			  	...
			  	<div class="panel-body">
			    	<form id = "form1" accept-charset="UTF-8" role="form"  method="POST" action="user.do?login">
                    <fieldset>
			    	  	<div class="form-group">
			    		    <input id = account class="form-control" placeholder="account" name="uid" type="text">
			    		</div>
			    		<div class="form-group">
			    			<input id =password class="form-control" placeholder="cname" name="cname" type="password" value="">
			    		</div>
